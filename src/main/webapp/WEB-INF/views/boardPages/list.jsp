...
<div class="container mt-3" >
    <form action="/board/search" method="get">
        ...
        <input type="submit" class="btn-outline-primarys" value="검색">
    </form>
</div>
...
<div class="container">
    <table class="table">
        ...
        <c:forEach items="${boardList}" var="board">
            <tr>
                <td>${board.id}</td>
                <td><a href="/board/detail?page=${paging.page}&id=${board.id}
                &boardWriter=${board.boardWriter}">${board.boardTitle}</a></td>
